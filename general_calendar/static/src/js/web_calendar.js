...
"use strict";
/*---------------------------------------------------------
 * OpenERP web_calendar editado para usar modo readonly
 *---------------------------------------------------------*/
...
var CalendarView = View.extend({
    ...
    get_fc_init_options: function () {
        ...
        return $.extend({}, get_fc_defaultOptions(), {
            ...
            header: false,
            selectable: !this.options.read_only_mode && this.create_right && this.editable, // adicionamos o comando "&& this.editable" MultidadosTI
            selectHelper: true,
    ...
    open_event: function(id, title) {
        ...
        if (! this.open_popup_action) {
            ...
            new form_common.FormViewDialog(this, {
                ...
                readonly: true,
                // create ternary if to add button 'Edit' and 'Delete' only when the record is editable: by MultidadosTI
                buttons: this.editable === true ? [
