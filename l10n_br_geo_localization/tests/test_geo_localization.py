...
class TestResPartner(TransactionCase):
    ...
    def test_zip_search(self, mock_api_call):
        ...
        assert -21 < record.partner_latitude < -20, "Latitude is wrong: 23 < %s < 24" % record.partner_latitude
        assert -50 < record.partner_longitude < -49, "Longitude is wrong: 46 < %s < 47" % record.partner_longitude
